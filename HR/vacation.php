                ...
                <?php foreach ($data as $item) : ?>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="/sem/HR/del_vac.php?vacation_id=<?php echo $item['vacation_id'] ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                                <a href="/sem/HR/del_vac.php?vacation_id=<?php echo $item['vacation_id'] ?>" class="btn btn-secondary"><i class="bi bi-pencil-square"></i></a>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" id="myForm" method="post">
                            ...
                            <div class="inputField">
                                ...
                                <div>
                                    <label for="pickupTime" class="form-label">Start Date:</label>
                                    <input type="date" id="pickupTime" name="from" class="form-control">
                                </div>
                                <div>
                                    <label for="pickupTime" class="form-label">End Date:</label>
