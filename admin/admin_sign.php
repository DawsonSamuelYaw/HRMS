...
session_start();
$username = $password = $email = $last = "";
$username_err = $password_err = $email_err = $last_err = "";
if (isset($_POST['sub'])) {
    ...
    if (empty($username_err) && empty($password_err) && empty($email_err) && empty($last_err)) {
        $check = "select * from admin_signup where email = '$email'";
    ...
    <form action="" method="post">
        <div class="main-con">
            <div class="logins">
                <?php echo $invalid; ?>
                <h1>Welcome 👋</h1>
                <p>Please Create Account Here as an Administrator</p>
                <div class="row ">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <p>Already a Member ? <a id="forget" href="admin_log.php">Sign In</a></p>
                    </div>
                </div>
            </div>
