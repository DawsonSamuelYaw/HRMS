...
if (isset($_POST['sub'])) {
    ...
    $info = "INSERT INTO salary (employee_name,pay,bouns,last_update) VALUES ('$name', '$pay', '$bonus', '$last')";
        ...
        <section class="container">
            <div id="section-main">
                ...
                <div class="section-right">
                    <button class="btn btn-primary newUser" data-bs-toggle="modal" data-bs-target="#userForm">ADD SALARY <i class="bi bi-people"></i></button>
                </div>
            </div>
            <table class="table">
                <thead>
                ...
                <?php foreach ($data as $item) : ?>
                    <tbody>
                        <tr>
                            ...
                            <td><?php echo $item['bouns'] ?></td>
                            <td><?php echo $item['last_update'] ?></td>
                            <td>
                                <a href="/sem/hr/del.php?id=<?php echo $item['id'] ?>" class="btn btn-danger"><i class="bi bi-trash"></i></a>
                                <a href="/sem/hr/pay.php?id=<?php echo $item['id'] ?>" class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
                            </td>
                        </tr>
                    ...
                    <div class="modal-body">
                        ...
                        <form action="" id="myForm" method="post">
                            ...
                            <div class="inputField">
                                <div>
                                    <label for="pickupLocation" class="form-label">Employee Name:</label>
                                ...
                                <div>
                                    <label for="pickupLocation" class="form-label">Salary:</label>
                                    <input type="number" id="pickupLocation" name="num" class="form-control" placeholder="Enter Salary">
                                </div>
                                <div>
                                    <label for="pickupLocation" class="form-label">Bonus:</label>
                                    <input type="number" id="pickupLocation" name="bonus" class="form-control" placeholder="Enter Bonus">
                                </div>
                                <div>
                                    <label for="pickupLocation" class="form-label">Last Update:</label>
                                    <input type="date" id="pickupLocation" name="date" class="form-control" placeholder="Enter Department">
                                </div>
