                        ...
                        <form action="" id="myForm" method="post">
                            ...
                            <div class="inputField">
                                ...
                                <div>
                                    ...
                                    <input type="number" id="pickupLocation" name="num" class="form-control" placeholder="Enter Department">
                                </div>
                                <div>
                                    <label for="pickupLocation" class="form-label">Bonus:</label>
                                    <input type="number" id="pickupLocation" name="bonus" class="form-control" placeholder="Enter Department">
                                </div>
                                <div>
