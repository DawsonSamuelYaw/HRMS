...
/* if (isset($_POST['search'])) {
    $search = $_POST['sea'];
    $str = $conn->prepare("SELECT * FROM employee_info WHERE employee_Name = '$search' ");
    $str->fetch(PDO::FETCH_OBJ);
    $str->execute();
} */
session_start();
$ids = $_SESSION['id'];
...
<body>
    ...
    <main class="main-content">
        <div class="header">
            ...
            <?php foreach ($sh1 as $keys) : ?>
                <div class="profile">
                    <h3>HR |</h3>
                    <h3><?php echo $keys['First']; ?></h3>
                </div>
            <?php endforeach ?>
        </div>
        <hr>
        ...
        <section class="container">
            <div id="section-main">
                <div class="header-right row">
                    <div class="col-6">
                        <input type="search" placeholder="Search" name="sea" class="form-control w-125 ">
                    </div>
                    <div class="col-6">
                ...
                <?php foreach ($data as $item) : ?>
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <a href="/sem/admin/del.php?employee_id=<?php echo $item['employee_id'] ?> " class="btn btn-danger"><i class="bi bi-trash"></i></a>
                                <a href="/sem/admin/edit.php?employee_id=<?php echo $item['employee_id'] ?> " class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
